...
REF_DIR = HOME / "mcmc_reference" / "ref_sim"
REF_SIM = REF_DIR / "jsons" / "data_output.json"
...
fig.savefig("roberts_sim.png", dpi=200)
# %%
...
fullstate_df.to_csv("roberts.csv", index=False)
observation_df.to_csv("observation.csv", index=False)

# Write TOML output
with open("observation.toml", "w") as fp:
